 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://sailorboatServer/", wsdlLocation = "http://localhost:8080/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://sailorboatServer/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://sailorboatServer/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sailorboatServer/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
